...
const {
  ...
  CHALLENGER_L1_MONITOR_HEIGHT,
  CHALLENGER_L2_MONITOR_HEIGHT,
...
export const config = {
  ...
  EXECUTOR_L2_MONITOR_HEIGHT: EXECUTOR_L2_MONITOR_HEIGHT
    ...
    : 0,
  CHALLENGER_L1_MONITOR_HEIGHT: CHALLENGER_L1_MONITOR_HEIGHT
    ? parseInt(CHALLENGER_L1_MONITOR_HEIGHT)
    : 0,
  CHALLENGER_L2_MONITOR_HEIGHT: CHALLENGER_L2_MONITOR_HEIGHT
    ? parseInt(CHALLENGER_L2_MONITOR_HEIGHT)
    : 0,
